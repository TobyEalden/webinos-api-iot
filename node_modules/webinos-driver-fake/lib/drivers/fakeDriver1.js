    ...
    exports.execute = function(cmd, eId, data, errorCB, successCB) {
        ...
        switch(cmd) {
            case 'cfg':
                ...
                console.log('Fake driver 1 - Received cfg for element '+eId+', cfg is '+ JSON.stringify(data));
                var index = -1;
            ...
            case 'start':
                ...
                console.log('Fake driver 1 - Received start for element '+eId+', mode is '+data);
                var index = -1;
                for(var i in elementsList) {
                    if(elementsList[i].id == eId){
                        index = i;
            ...
            case 'stop':
                ...
                console.log('Fake driver 1 - Received stop for element '+eId);
                var index = -1;
                for(var i in elementsList) {
                    if(elementsList[i].id == eId)
                        index = i;
            ...
            case 'value':
                ...
                console.log('Fake driver 1 - Received value for element '+elementsList[index].id+'; value is '+data.actualValue);
                callbackFunc('value', elementsList[index].id, data);
